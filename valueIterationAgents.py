...
class ValueIterationAgent(ValueEstimationAgent):
        ...
        for i in range(self.iterations):
            ...
            for s in states:
                if not self.mdp.isTerminal(s):
                    ...
                    if bestAction != None:
                        value[s] = self.computeQValueFromValues(s, bestAction)
            self.values = value
    ...
    def computeQValueFromValues(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        #use the value iteration state update equation
        #getTransiton Returns list of (nextState, prob) pairs
        ...
        for i in transitionProb:
            ...
            qVal += i[1] * (reward + (self.discount * self.values[i[0]]))
        return qVal
